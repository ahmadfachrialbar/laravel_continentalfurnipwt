<footer class="bg-primary text-white mt-[100px] rounded-t-3xl">
  <div class="max-w-[1280px] mx-auto px-[75px]">
    <!-- Main Footer Content -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[30px] py-[50px] border-b border-white/10">
      <!-- Company Info -->
        <div class="space-y-5">
          <div class="space-y-3">
          ...
          <div class="flex gap-3">
            <a href="#" class="w-10 h-10 rounded-full border border-white/20 flex items-center justify-center hover:bg-white hover:text-primary transition-all duration-300">
